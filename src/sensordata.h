...
public:
    ...
    ros::Subscriber sub_rtk_gps,sub_gps_filtered,sub_cexiang_gps,sub_garmin_gps,sub_imu,sub_cexiang_orientation,sub_yaw_filtered;
    ...
    void filtered_gpsCallback(const sensor_msgs::NavSatFix::ConstPtr &gps_in);
    ...
    void filtered_yawCallback(const std_msgs::Float64 output_direction);
...
private:
    ...
    double filtered_gps_latitude,filtered_gps_longtitude,filtered_yaw;
